  ...
  <div v-for="(block, index) in content" :key="block.id">
    ...
    <div v-else-if="block.type === 'code'">
      <div v-for="text in block.code.rich_text">
        ...
        <div
          v-else-if="block.code.language === 'plain text'"
          v-html="
    ...
    <v-divider v-else-if="block.type === 'divider'" thickness="3"> </v-divider>
    ...
    <NotionHeading1
      :block="block"
      v-else-if="block.type === 'heading_1' && !block.heading_1.is_toggleable"
    />
    <NotionHeading2
      :block="block"
      v-else-if="block.type === 'heading_2' && !block.heading_2.is_toggleable"
    />
    <NotionHeading3
    ...
    <NotionToggle
      v-else-if="block.type === 'toggle' || block[block.type].is_toggleable"
      :block="block"
    />
