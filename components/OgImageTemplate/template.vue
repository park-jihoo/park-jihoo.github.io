...
const backgroundAttrs = computed(() => {
  return {
    style: {
      ...
      width: '100%',
      height: '100%',
      background: 'linear-gradient(135deg, rgba(255, 223, 186, 0.5) 0%, rgba(204, 255, 144, 0.5) 100%)',
    },
  };
});
...
const backgroundFlareAttrs = computed(() => {
  return {
    style: {
      ...
      width: '200%',
      height: '200%',
      backgroundImage: 'radial-gradient(circle, rgba(255, 223, 186, 0.5) 0%, rgba(204, 255, 144, 0.5) 50%, rgba(255, 223, 186, 0) 70%)',
    },
  };
});
